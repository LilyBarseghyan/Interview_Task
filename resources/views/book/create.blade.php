        ...
        <div class="card m-3  bg-white">
            <div class="card-body">
                ...
                <div class="col-md-12 mb-4">
                    ...
                    <input type="text" class="form-control @if($errors->has('title'))is-invalid @endif" id="title" name="title">
                    @if($errors->has('title'))
                ...
                <div class="col-md-12 mb-4">
                    ...
                    <textarea rows="5" class="form-control @if($errors->has('content'))is-invalid @endif" id="content" name="content"></textarea>
